...
def print_retrieved_chunks(retrieved_chunks: list[dict]) -> None:
    ...
    """
    print("\n[검색된 근거 - Hybrid Embedding Search]")
    ...
    for index, chunk in enumerate(retrieved_chunks, start=1):
        ...
        print(f"최종 점수: {chunk['score']}")
        print(f"임베딩 점수: {chunk['embedding_score']}")
        print(f"키워드 점수: {chunk['keyword_score']}")
        print(f"보정 점수: {chunk['boost_score']}")
        print(f"내용: {chunk['text'][:200]}...")


def main() -> None:
    print("Course Study RAG Tutor - Embedding Search v2")
    print("=" * 50)
    ...
    print("chunk embedding을 생성하는 중입니다...")
